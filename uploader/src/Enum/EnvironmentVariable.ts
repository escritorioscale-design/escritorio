...
const ENABLE_CHAT_UPLOAD = !["false", "0"].includes(
  (process.env.ENABLE_CHAT_UPLOAD ?? "true").toLowerCase(),
);
...
export const MAX_UPLOAD_SIZE =
  parsedMaxUploadSize > 0 ? parsedMaxUploadSize : DEFAULT_MAX_UPLOAD_SIZE;
...
const UPLOADER_AWS_SIGNED_URL_EXPIRATION = parseInt(
  process.env.UPLOADER_AWS_SIGNED_URL_EXPIRATION || "60",
);
...
export const ALLOWED_CORS_ORIGIN =
  process.env.ALLOWED_CORS_ORIGIN || PLAY_URL || "*";
