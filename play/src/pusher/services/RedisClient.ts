...
import { REDIS_HOST, REDIS_PASSWORD, REDIS_PORT, REDIS_URL } from "../enums/EnvironmentVariable";

const config: RedisClientOptions = REDIS_URL
    ? { url: REDIS_URL }
    : {
          socket: {
              host: REDIS_HOST,
...
const redisClient = REDIS_URL !== undefined || REDIS_HOST !== undefined ? createClient(config) : null;
