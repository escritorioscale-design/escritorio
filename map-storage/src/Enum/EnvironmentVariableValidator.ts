...
export const EnvironmentVariables = z.object({
    ...
    HTTP_PORT: PositiveIntAsString.optional()
        ...
        .describe("HTTP port for the map-storage service. Defaults to 3000"),
    GRPC_PORT: PositiveIntAsString.optional()
        .transform((val) => toNumber(val, 50053))
        .describe("gRPC port for the map-storage service. Defaults to 50053"),
    AWS_ACCESS_KEY_ID: z
        .string()
        .optional()
